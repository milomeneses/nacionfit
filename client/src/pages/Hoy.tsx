...
import { getDay, getDays, putDay, toggleHabit } from '../lib/api';
...
const TABS = ['Hoy', 'Coach', 'Patrones', 'Plan'] as const;
          ...
          {TABS.map((t) => {
            ...
            return (
              <button
                ...
                } ${enabled ? 'hover:text-green' : 'cursor-not-allowed'}`}
              >
                {t}
              </button>
            );
                ...
                {INTENSITY_OPTIONS.map((o) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        update('projectIntensity', active ? null : o.value)
                      }
